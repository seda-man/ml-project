...
def res_net_layer(inputs,
                 ...
                 conv_first=True):
    """2D Convolution-Batch Normalization-Activation and 
    Batch Normalization-Activation-2D Convolution stack builder
    # Arguments
...
def res_net(input_shape, depth, num_classes=10):
